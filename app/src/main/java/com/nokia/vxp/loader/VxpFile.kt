 ...
 * section headers (used to locate .vm_res), the raw bytes of the
 * .vm_res resource section if present, and any MediaTek metadata tags
 * appended after the ELF data. This is what gets handed to
 * loader.ModuleMapper next.
 */
data class VxpFile(
